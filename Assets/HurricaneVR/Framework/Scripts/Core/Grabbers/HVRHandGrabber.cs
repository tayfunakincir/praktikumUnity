...
namespace HurricaneVR.Framework.Core.Grabbers
{
    public class HVRHandGrabber : HVRGrabberBase
    {
        ...
        public Vector3 dynamicGrabPoint;
        public Vector3 slideGrabPoint;
        ...
        public bool IsGripGrabActive;//Hack: originally protected, changed to public for exposure in AreaVRNetworkGrab
        public bool IsTriggerGrabActive;//Hack: originally protected, changed to public for exposure in AreaVRNetworkGrab
        ...
        private Vector3 GetLocalLineGrabPoint(HVRGrabbable grabbable, Vector3 point, HVRPosableGrabPoint grabPoint)
        {
            ...
            return dynamicGrabPoint = HVRUtilities.FindNearestPointOnLine(start, end, testPoint);
            //Hack: Exposing LocalLineGrabPoint by saving it to dynamicGrabPoint.
            //Hack: Needed to update Clone on Grabbing, cant find any native way to get that info. 
        }
        ...
        private void UpdateLineGrab()
        {
            ...
            if (PosableGrabPoint.LineCanReposition || PosableGrabPoint.LineCanRotate)
            {
                if (loosen)
                {
                    slideGrabPoint = GetLocalLineGrabPoint(GrabbedTarget, transform.TransformPoint(HandAnchorLocal),
                        PosableGrabPoint); //Hack: Exposing LocalLineGrabPoint while looseGrabbing for AreaVRNetworkGrab.
                                           //Hack: Needed to update Clone while looseGrabbing, cant find any native way to get that info. 
                }
